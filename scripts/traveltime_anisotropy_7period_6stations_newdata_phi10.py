#!/usr/bin/env python3
"""
traveltime_anisotropy_7period_6stations_newdata_phi10.py
...
Produces: traveltime_anisotropy_7period_6stations_newdata_phi10.pdf (1 page)

Run with:
    python3 traveltime_anisotropy_7period_6stations_newdata_phi10.py
"""
...
OUT_PDF = os.path.join(HERE, 'traveltime_anisotropy_7period_6stations_newdata_phi10.pdf')
