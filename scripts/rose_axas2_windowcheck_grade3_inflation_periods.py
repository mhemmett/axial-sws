#!/usr/bin/env python3
"""
rose_axas2_windowcheck_grade3_inflation_periods.py

AXAS2-only rose plot, same data/filter as rose_7period_regions_windowcheck_grade3.py (windowcheck
...
This directly compares the AXAS2 fast-direction rose across periods of equal PHYSICAL INFLATION
...
Produces: rose_axas2_windowcheck_grade3_inflation_periods.pdf (1 page, 1 row x 7 columns) -- a
NEW file, does not touch rose_7period_regions_windowcheck_grade3.pdf or any other existing
output.

Run with:
    python3 rose_axas2_windowcheck_grade3_inflation_periods.py
"""
...
OUT_PDF = os.path.join(HERE, 'rose_axas2_windowcheck_grade3_inflation_periods.pdf')
