#!/usr/bin/env python3
"""
traveltime_anisotropy_7period_6stations_newdata.py
...
Produces: traveltime_anisotropy_7period_6stations_newdata.pdf (1 page)

Run with:
    python3 traveltime_anisotropy_7period_6stations_newdata.py
"""
...
OUT_PDF = os.path.join(HERE, 'traveltime_anisotropy_7period_6stations_newdata.pdf')
