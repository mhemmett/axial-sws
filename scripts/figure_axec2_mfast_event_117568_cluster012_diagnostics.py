...
Event: AXEC2, event_id 471_117568 (batch 471), origin 2020-09-03T07:09:32.678000.
...
Production metadata (raw_axec2_all_batches_mfast_filters_data metadata + splitting results):
    quality (Q_w, Wustefeld 2010) = 0.842865  (> 0.7 threshold: yes)
    phi_error = 8 deg, dt_error = 0.01 s (both inside phi_error<20 deg / dt_error<0.04 s)
    dt = 0.12 s
    depth = 0.497 km, SNR = 7.47, rectilinearity = 0.894
...
The waveform file (raw_axec2_all_batches_mfast_filters_data/waveforms/batch471_event_2020-09-03T07-09-32.678000Z.mseed)
...
OUT_PDF = os.path.join(HERE, 'figure_axec2_mfast_event_117568_cluster012_diagnostics.pdf')
...
WAVEFORM_PATH = os.path.join(HERE, 'raw_axec2_all_batches_mfast_filters_data', 'waveforms',
                              'batch471_event_2020-09-03T07-09-32.678000Z.mseed')
ORIGIN_TIME = UTCDateTime('2020-09-03T07:09:32.678000Z')
S_ARRIVAL_TIME = 0.752   # seconds from origin
P_ARRIVAL_TIME = 0.352   # seconds from origin
BACK_AZIMUTH = 279.57231
INCIDENCE_PYKONAL_S = 19.250614   # drives LQT rotation + QC in production
SNR_HORIZONTAL = 7.467816
RECTILINEARITY = 0.893696
DEPTH_KM = 0.497
