...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct  3 09:53:20 2018
...
plt.close('all')
data_file='movehisto.dat'
data_file='movehisto_date.pickle'

[lags,time_rel]=pickle.load(open(data_file,'rb'))
...
x_width=40
y_width=1
movehisto2d(x,y,x_width,y_width,
                x_start=None,y_start=None,x_end=None,y_end=None,
                x_over=0.7,y_over=0.7,
                norm_y=False,smooth=True,gaussian_x_per=0.5,gaussian_y_per=0.5,
                x_label='X',y_label='Y',text_list='')