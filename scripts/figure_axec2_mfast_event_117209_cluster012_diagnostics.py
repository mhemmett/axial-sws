...
Event: AXEC2, event_id 469_117209 (batch 469), origin 2020-08-27T10:24:43.298000.
...
Production metadata (raw_axec2_all_batches_mfast_filters_data metadata + splitting results):
    quality (Q_w, Wustefeld 2010) = 0.780011  (> 0.7 threshold: yes)
    phi_error = 11 deg, dt_error = 0.01 s (both inside phi_error<20 deg / dt_error<0.04 s)
    dt = 0.12 s
    depth = 1.570 km, SNR = 3.07, rectilinearity = 0.951
...
The waveform file (raw_axec2_all_batches_mfast_filters_data/waveforms/batch469_event_2020-08-27T10-24-43.298000Z.mseed)
...
OUT_PDF = os.path.join(HERE, 'figure_axec2_mfast_event_117209_cluster012_diagnostics.pdf')
...
WAVEFORM_PATH = os.path.join(HERE, 'raw_axec2_all_batches_mfast_filters_data', 'waveforms',
                              'batch469_event_2020-08-27T10-24-43.298000Z.mseed')
ORIGIN_TIME = UTCDateTime('2020-08-27T10:24:43.298000Z')
S_ARRIVAL_TIME = 0.842   # seconds from origin
P_ARRIVAL_TIME = 0.392   # seconds from origin
BACK_AZIMUTH = 212.452051
INCIDENCE_PYKONAL_S = 14.615793   # drives LQT rotation + QC in production
SNR_HORIZONTAL = 3.074611
RECTILINEARITY = 0.951292
DEPTH_KM = 1.57
