#!/usr/bin/env python3
"""
traveltime_anisotropy_7period_6stations_newdata_diff.py
...
Produces: traveltime_anisotropy_7period_6stations_newdata_diff.pdf (1 page)

Run with:
    python3 traveltime_anisotropy_7period_6stations_newdata_diff.py
"""
...
OUT_PDF = os.path.join(HERE, 'traveltime_anisotropy_7period_6stations_newdata_diff.pdf')
