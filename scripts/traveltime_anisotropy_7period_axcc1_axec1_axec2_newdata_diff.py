#!/usr/bin/env python3
"""
traveltime_anisotropy_7period_axcc1_axec1_axec2_newdata_diff.py

DIFFERENCE-FROM-PRE-ERUPTION variant of traveltime_anisotropy_7period_axcc1_axec1_axec2_
newdata.py: identical data sources, QC, ray tracing, voxel grid, and travel-time-weighted
percent-anisotropy aggregation (A_ray = dt*100/T_travel, V_voxel = travel-time-weighted mean
-- see that script's docstring for the full method/data-source description, not repeated
here). The only difference is what gets PLOTTED:
...
Produces: traveltime_anisotropy_7period_axcc1_axec1_axec2_newdata_diff.pdf (1 page)

Run with:
    python3 traveltime_anisotropy_7period_axcc1_axec1_axec2_newdata_diff.py
"""
...
OUT_PDF = os.path.join(HERE, 'traveltime_anisotropy_7period_axcc1_axec1_axec2_newdata_diff.pdf')
...
EXCLUDED_STATIONS = ['AXAS1', 'AXAS2', 'AXEC3']
...
def main():
    ...
    title = (f'AXCC1/AXEC1/AXEC2 (new mfast max_dt=0.2s data) — pre-eruption anisotropy '
