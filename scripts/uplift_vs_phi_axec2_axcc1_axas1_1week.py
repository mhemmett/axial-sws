#!/usr/bin/env python3
"""
uplift_vs_phi_axec2_axcc1_axas1_1week.py
...
1-WEEK window (step=1 day, MIN_N lowered from 15 to 5 to match the far smaller per-window
event counts at this resolution -- AXCC1 in particular only averages ~0.9 events/day
post-eruption). Per explicit user request, this (and the companion _2week.py) exists purely
...
Produces (NEW file, 4 pages):
    uplift_vs_phi_axec2_axcc1_axas1_1week.pdf

Run with:
    python3 uplift_vs_phi_axec2_axcc1_axas1_1week.py
"""
...
OUT_PDF = os.path.join(HERE, 'uplift_vs_phi_axec2_axcc1_axas1_1week.pdf')
