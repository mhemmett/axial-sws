#!/usr/bin/env python3
"""
traveltime_anisotropy_7period_6stations_newdata_diff_fractional.py

DIFFERENCE-FROM-PRE-ERUPTION variant of traveltime_anisotropy_7period_6stations_newdata.py:
identical data sources (6 stations: AXAS1, AXAS2, AXCC1, AXEC1, AXEC2, AXEC3), Tier 4 QC
(quality>=0.5, dt<T_dom/2, phi_err<20deg, dt_err<0.05s), ray tracing, voxel grid, and
...
Produces: traveltime_anisotropy_7period_6stations_newdata_diff_fractional.pdf (1 page)

Run with:
    python3 traveltime_anisotropy_7period_6stations_newdata_diff_fractional.py
"""
...
OUT_PDF = os.path.join(HERE, 'traveltime_anisotropy_7period_6stations_newdata_diff_fractional.pdf')
