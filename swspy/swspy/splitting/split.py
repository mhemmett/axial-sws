...
class create_splitting_object:
    ...
    def __init__(self, st, nonlinloc_event_path=None, event_uid=None, stations_in=[], S_phase_arrival_times=[], origin_times = [], back_azis_all_stations=[], receiver_inc_angles_all_stations=[], first_window_start=2, last_window_start=1, first_window_end=1.5, last_window_end=2.5, n_win=10, s_pick_uncertainty=0.0509):
