#!/usr/bin/env python3
"""
traveltime_anisotropy_7period_axcc1_axec1_axec2_newdata.py

New version of lqt_pykonal_tomography_traveltime_anisotropy.py's 7-period travel-time-
weighted percent-anisotropy tomography, using ONLY the new mfast max_dt=0.2s data for
AXCC1, AXEC1, and AXEC2 (the same three stations covered by
...
AXAS1, AXAS2, AXEC3 are EXCLUDED from the anisotropy computation entirely (no new data for
them) but their station markers are still drawn for spatial reference, in WHITE, vs. YELLOW
for the three included stations (AXCC1, AXEC1, AXEC2) -- same marker shape/size/edge as
...
Produces: traveltime_anisotropy_7period_axcc1_axec1_axec2_newdata.pdf (1 page)

Run with:
    python3 traveltime_anisotropy_7period_axcc1_axec1_axec2_newdata.py
"""
...
OUT_PDF = os.path.join(HERE, 'traveltime_anisotropy_7period_axcc1_axec1_axec2_newdata.pdf')
...
INCLUDED_STATIONS = ['AXCC1', 'AXEC1', 'AXEC2']   # new-data stations -> traced + yellow markers
EXCLUDED_STATIONS = ['AXAS1', 'AXAS2', 'AXEC3']   # reference-only -> white markers, not traced
...
def main():
    ...
    title = (f'AXCC1/AXEC1/AXEC2 (new mfast max_dt=0.2s data) — travel-time-weighted mean % '
