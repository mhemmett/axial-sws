#!/usr/bin/env python3
"""
traveltime_anisotropy_7period_5stations_newdata_diff.py

DIFFERENCE-FROM-PRE-ERUPTION variant of traveltime_anisotropy_7period_5stations_newdata.py:
identical data sources (5 stations: AXAS1, AXCC1, AXEC1, AXEC2, AXEC3 -- AXAS2 excluded, no
new-data rerun yet), QC, ray tracing, voxel grid, and travel-time-weighted percent-anisotropy
...
Produces: traveltime_anisotropy_7period_5stations_newdata_diff.pdf (1 page)

Run with:
    python3 traveltime_anisotropy_7period_5stations_newdata_diff.py
"""
...
OUT_PDF = os.path.join(HERE, 'traveltime_anisotropy_7period_5stations_newdata_diff.pdf')
...
INCLUDED_STATIONS = ['AXAS1', 'AXCC1', 'AXEC1', 'AXEC2', 'AXEC3']
EXCLUDED_STATIONS = ['AXAS2']
...
def main():
    ...
    title = (f'AXAS1/AXCC1/AXEC1/AXEC2/AXEC3 (new mfast max_dt=0.2s data) — pre-eruption anisotropy '
