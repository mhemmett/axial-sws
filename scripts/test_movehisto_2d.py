...
(X,Y,Z)=movehisto2d_bin(x,y,x_width=200,y_width=10,
                    x_mode='sample',
                x_start=0,y_start=None,x_end=30,y_end=None,
                x_over=0.9,y_over=0.9,
                flag_y_norm=False,
                flag_resample=True,dx_resample=None,dy_resample=None,
                flag_filter=True,x_filter_per=0.1,y_filter_per=0.1,filter_mode='nearest')
