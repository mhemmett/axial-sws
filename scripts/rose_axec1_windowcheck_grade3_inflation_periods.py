#!/usr/bin/env python3
"""
rose_axec1_windowcheck_grade3_inflation_periods.py

AXEC1-only rose plot, same data/filter as rose_7period_regions_windowcheck_grade3.py (windowcheck
...
This directly compares the AXEC1 fast-direction rose across periods of equal PHYSICAL INFLATION
...
Run with:
    python3 rose_axec1_windowcheck_grade3_inflation_periods.py
"""
...
OUT_PDF = os.path.join(HERE, 'rose_axec1_windowcheck_grade3_inflation_periods.pdf')
