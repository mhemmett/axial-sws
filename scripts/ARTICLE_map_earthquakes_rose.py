...
x_lim=[5,12.5]
y_lim=[1,8]
lon_lim,lat_lim=gproj.xy2ll(x_lim,y_lim,ini_lon,ini_lat)

lon_lim=list(lon_lim)
lat_lim=list(lat_lim)
...
(_,im)=ggmt.plot_netcdf(netcdf_file,ini_lon=ini_lon,ini_lat=ini_lat,lon_lim=lon_lim,lat_lim=lat_lim,
vmin=-2300,vmax=-1400,cmap=cmap,shade=True,ax=ax)
...
if flag_save:    
    name_png='ARTICLE_map_earthquakes_rose.png'
    name_pdf='ARTICLE_map_earthquakes_rose.pdf'
