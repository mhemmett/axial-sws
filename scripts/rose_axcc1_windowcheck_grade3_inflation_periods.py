#!/usr/bin/env python3
"""
rose_axcc1_windowcheck_grade3_inflation_periods.py

AXCC1-only rose plot, same data/filter as rose_7period_regions_windowcheck_grade3.py (windowcheck
...
This directly compares the AXCC1 fast-direction rose across periods of equal PHYSICAL INFLATION
...
Run with:
    python3 rose_axcc1_windowcheck_grade3_inflation_periods.py
"""
...
OUT_PDF = os.path.join(HERE, 'rose_axcc1_windowcheck_grade3_inflation_periods.pdf')
