#!/usr/bin/env python3
"""
traveltime_anisotropy_7period_6stations_newdata_phi10_diff.py
...
travel-time-weighted percent-anisotropy
aggregation (A_ray = dt*100/T_travel, V_voxel = travel-time-weighted mean -- see that script's
docstring for the full method/data-source description, not repeated here). The only
difference is what gets PLOTTED:
...
Produces: traveltime_anisotropy_7period_6stations_newdata_phi10_diff.pdf (1 page)

Run with:
    python3 traveltime_anisotropy_7period_6stations_newdata_phi10_diff.py
"""
...
OUT_PDF = os.path.join(HERE, 'traveltime_anisotropy_7period_6stations_newdata_phi10_diff.pdf')
...
def main():
    ...
    title = (f'AXAS1/AXAS2/AXCC1/AXEC1/AXEC2/AXEC3 (new mfast max_dt=0.2s data) — pre-eruption anisotropy '
