...
Event: AXEC2, event_id 485_121079 (batch 485), origin 2021-05-03T18:53:04.720000.
...
Production metadata (raw_axec2_all_batches_mfast_filters_data metadata + splitting results):
    quality (Q_w, Wustefeld 2010) = 0.832180  (> 0.7 threshold: yes)
    phi_error = 16 deg, dt_error = 0.015 s (both inside phi_error<20 deg / dt_error<0.04 s)
    dt = 0.12 s
    depth = 0.538 km, SNR = 6.17, rectilinearity = 0.984
...
The waveform file (raw_axec2_all_batches_mfast_filters_data/waveforms/batch485_event_2021-05-03T18-53-04.720000Z.mseed)
...
OUT_PDF = os.path.join(HERE, 'figure_axec2_mfast_event_121079_cluster012_diagnostics.pdf')
...
WAVEFORM_PATH = os.path.join(HERE, 'raw_axec2_all_batches_mfast_filters_data', 'waveforms',
                              'batch485_event_2021-05-03T18-53-04.720000Z.mseed')
ORIGIN_TIME = UTCDateTime('2021-05-03T18:53:04.720000Z')
S_ARRIVAL_TIME = 0.95   # seconds from origin
P_ARRIVAL_TIME = 0.49   # seconds from origin
BACK_AZIMUTH = 297.519158
INCIDENCE_PYKONAL_S = 19.978232   # drives LQT rotation + QC in production
SNR_HORIZONTAL = 6.16852
RECTILINEARITY = 0.984143
DEPTH_KM = 0.538
