#!/usr/bin/env python3
"""
traveltime_anisotropy_7period_6stations_newdata_phi10_fractional.py

STRICTER-phi variant of traveltime_anisotropy_7period_6stations_newdata.py: identical
everything (6 stations, data sources, ray tracing, aggregation) except phi_err<10deg
(Tier 4 + phi<10, matching the rose plot's stricter tier) instead of phi_err<20deg.
...
All 6 stations are now included and traced (yellow markers).
...
Produces: traveltime_anisotropy_7period_6stations_newdata_phi10_fractional.pdf (1 page)

Run with:
    python3 traveltime_anisotropy_7period_6stations_newdata_phi10_fractional.py
"""
...
OUT_PDF = os.path.join(HERE, 'traveltime_anisotropy_7period_6stations_newdata_phi10_fractional.pdf')
