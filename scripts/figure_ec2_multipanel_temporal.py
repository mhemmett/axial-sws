...
established for the production AXEC2 rose and temporal-histogram plots:
  ...
  - Data: lqt_pykonal_combined_results/splitting_results_AXEC2_{2015_2021,
...
OUT_PDF = os.path.join(HERE, 'figure_ec2_multipanel_temporal.pdf')
...
def load_axec2_enriched():
    d1 = pd.read_csv(os.path.join(DATA_DIR, 'splitting_results_AXEC2_2015_2021_all_batches_enriched.csv'))
...
def main():
    print('Loading AXEC2 enriched LQT + PyKonal-FMM results (2015-2026)...')
    ...
    fig.suptitle('EC2: Shear-wave Splitting Measurements Over Time', fontsize=17 * FONT_SCALE,
