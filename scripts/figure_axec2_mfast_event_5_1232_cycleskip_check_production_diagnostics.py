"""
figure_axec2_mfast_event_5_1232_cycleskip_check_production_diagnostics.py
...
Run with: python3 figure_axec2_mfast_event_5_1232_cycleskip_check_production_diagnostics.py
"""
...
OUT_PDF = os.path.join(HERE, 'figure_axec2_mfast_event_5_1232_cycleskip_check_production_diagnostics.pdf')
...
def main():
    ...
    # swspy's own default of 0.30s -- this is exactly the parameter under investigation.
    ...
    with PdfPages(OUT_PDF) as pdf:
        ...
        plot_multipanel_summary_page(
            ...
            title_suffix='Cycle-Skip Check (Production)',
        )
